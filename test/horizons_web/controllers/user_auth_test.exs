defmodule HorizonsWeb.UserAuthTest do
  use HorizonsWeb.ConnCase, async: true

  alias Horizons.Accounts
  alias HorizonsWeb.UserAuth
  import Horizons.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HorizonsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HorizonsWeb.Endpoint.subscribe(live_socket_id)
